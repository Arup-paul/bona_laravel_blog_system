                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                          ...
                                          <tbody>
                                              ...
                                              <td>
                                              <a class="brn btn-sm btn-success" target="_blank" href="{{route('post.details',$post->slug)}}"><i class="fa fa-eye"></i></a>
                                              </td>
                                              </tr>
                                              @endforeach
                                          </tbody>
...
@push('js')
   <!-- Jquery CountTo Plugin Js -->
    ...
    {{-- <script src="{{asset('assets/backend/plugins/materialize-css/js/materialize.min.js')}}"></script> --}}
