...
<head>
    ...
    <link href="{{asset('assets/backend/plugins/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/backend/plugins/materialize-css/css/materialize.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/backend/plugins/material-design-iconic-font/css/material-design-iconic-font.min.css')}}" rel="stylesheet">
    <!-- Bootstrap Core Css -->
